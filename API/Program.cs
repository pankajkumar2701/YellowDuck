...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "YellowDuck", Version = "v1" });
...
builder.Services.AddTransient<YellowDuckContext>();
...
if (app.Environment.IsDevelopment() || app.Environment.IsStaging() || app.Environment.IsProduction())
{
    ...
    app.UseSwaggerUI(c =>
    {
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "YellowDuck API v1");
