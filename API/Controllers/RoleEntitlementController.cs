...
using YellowDuck.Models;
using YellowDuck.Data;
using YellowDuck.Filter;
using YellowDuck.Entities;
using YellowDuck.Authorization;
using Microsoft.AspNetCore.Authorization;

namespace YellowDuck.Controllers
{
    /// <summary>
    ...
    {
        private readonly YellowDuckContext _context;

        public RoleEntitlementController(YellowDuckContext context)
        {
            _context = context;
        }
